...
async function logout() {
  try {
    ...
    // Navigate to login page, remembering where the session expired so the
    // user returns there after signing back in.
...
export const authAPI = {
  ...
  verifyResetCode: (phone, code) =>
    request({
      ...
      method: "POST",
      content: { phone: phone.trim(), code: code.trim() },
    }),

  confirmResetPassword: (phone, code, new_password) =>
    request({
      url: "/auth/password-reset/confirm",
      method: "POST",
      content: { phone: phone.trim(), code: code.trim(), new_password },
    }),
...
export const fileUploadAPI = {
  ...
  uploadAvatar: async (file) => {
    ...
    const response = await fetch(
      `${BASE_URL}/users/${userStore.getUserProfile.user_id || userStore.getUserProfile.id
      }/upload-avatar`,
      {
        method: "POST",
        headers,
...
export const userAPI = {
  getProfile: () =>
    request({
      url: `/users/${userStore.getUserProfile.user_id || userStore.getUserProfile.id
        }`,
      method: "GET",
    }),
...
export const vocabularyAPI = {
  ...
  updateVocabularyStatus: (vocabularyId) =>
    request({
      url: `/student-vocabulary-progress/student/${userStore.getUserProfile.user_id || userStore.getUserProfile.id
  ...
  getStats: () =>
    request({
      url: `/student-vocabulary-progress/stats/student/${userStore.getUserProfile.user_id || userStore.getUserProfile.id
        }`,
      method: "GET",
    }),
  ...
  getStudentWordsProgress: () =>
    request({
      url: `/vocabulary-sets/progress/${userStore.getUserProfile.user_id || userStore.getUserProfile.id
        }`,
      method: "GET",
    }),
...
// IELTS Vocabulary API (student-facing, read-only)
export const ieltsVocabStudentAPI = {
  getAll: (page = 1, limit = 10) =>
    request({
      url: `/ielts-vocabulary?page=${page}&limit=${limit}`,
      method: "GET",
    }),

  getById: (id) => request({ url: `/ielts-vocabulary/${id}`, method: "GET" }),

  getDeck: (id) =>
    request({ url: `/ielts-vocabulary/decks/${id}`, method: "GET" }),

  getWords: (deckId, page = 1, limit = 100) =>
    request({
      url: `/ielts-vocabulary/words/all?deckId=${deckId}&page=${page}&limit=${limit}`,
      method: "GET",
    }),
};
...
export const homeworkAPI = {
  getHomeWork: () =>
    request({
      url: `/group-homeworks/active/${userStore.getUserProfile.user_id || userStore.getUserProfile.id
        }`,
      method: "GET",
    }),
...
export const booksAPI = {
  ...
  getStudentsBook: () =>
    request({
      url: `/student-books/student/${userStore.getUserProfile.user_id || userStore.getUserProfile.id
        }`,
      method: "GET",
    }),
...
export const examsAPI = {
  getExams: () =>
    request({
      url: `/exams/user/${userStore.getUserProfile.user_id || userStore.getUserProfile.id
        }`,
      method: "GET",
    }),
  ...
  getExamResults: (examId) =>
    request({
      url: `/exam-results/exam/${examId}/student/${userStore.getUserProfile.user_id || userStore.getUserProfile.id
        }`,
      method: "GET",
    }),
  ...
  getMyRegistrations: () =>
    request({
      url: `/cd-ielts/registrations/student/${userStore.getUserProfile.user_id || userStore.getUserProfile.id
        }`,
      method: "GET",
    }),
};
...
export const progressAPI = {
  ...
  getAllAwards: (userId) =>
    request({
      url: `/student-profiles/user/${userId || userStore.getUserProfile.user_id
        }`,
      method: "GET",
    }),
  ...
  updatePoints: (amount) =>
    request({
      url: `/student-profiles/${userStore.getUserProfile.user_id || userStore.getUserProfile.id
        }/points/add/${amount}`,
      method: "PATCH",
    }),
  ...
  getLevelLeaderboard: () =>
    request({
      url: `/student-profiles/leaderboard/level?userId=${userStore.getUserProfile.user_id || userStore.getUserProfile.id
        }&limit=100`,
      method: "GET",
    }),
  ...
  getCurrentUserRank: (userId) =>
    request({
      url: `/student-profiles/ranking/points/${userId || userStore.getUserProfile.user_id
        }`,
      method: "GET",
    }),
  ...
  getAttendanceStats: () =>
    request({
      url: `/attendance/student/${userStore.getUserProfile.user_id || userStore.getUserProfile.id
        }/current-month`,
      method: "GET",
    }),
  ...
  getOverallSectionsProgress: () =>
    request({
      url: `/homework-submissions/student/${userStore.getUserProfile.user_id || userStore.getUserProfile.id
        }/stats`,
      method: "GET",
    }),
};
...
export const paymentsAPI = {
  getPaymentStatus: () =>
    request({
      url: `/student-payments/student/${userStore.getUserProfile.user_id || userStore.getUserProfile.id
        }/status`,
      method: "GET",
    }),
...
export const speakingAPI = {
  ...
  checkSpeakingSubmission: (speakingId) =>
    request({
      url: `/speaking-responses/check-submission?lessonId=${speakingId}&studentId=${userStore.getUserProfile.user_id || userStore.getUserProfile.id
        }`,
      method: "GET",
    }),
};
...
export const certificatesAPI = {
  getStudentCertificates: (studentId) =>
    request({
      url: `/certificates/student/${studentId ||
        userStore.getUserProfile.user_id ||
        userStore.getUserProfile.id
        }`,
      method: "GET",
...
export const ieltsAPI = {
  ...
  getTests: ({ page = 1, limit = 10, mode = "", category = "", search = "", type = "" } = {}) => {
    const params = new URLSearchParams({ page, limit });
    if (mode) params.append("mode", mode);
    if (category) params.append("category", category);
    if (search) params.append("search", search);
  ...
  getReadingParts: ({ page = 1, limit = 10, part = "", mode = "", search = "", testId = "" } = {}) => {
    const params = new URLSearchParams({ page, limit });
    if (part) params.append("part", part);
    if (mode) params.append("mode", mode);
    if (search) params.append("search", search);
    if (testId) params.append("readingId", testId);
    return request({
  ...
  getListeningParts: ({ page = 1, limit = 10, part = "", mode = "", search = "", testId = "" } = {}) => {
    const params = new URLSearchParams({ page, limit });
    if (part) params.append("part", part);
    if (mode) params.append("mode", mode);
    if (search) params.append("search", search);
    if (testId) params.append("listeningId", testId);
    return request({
  ...
  getWritingTasks: ({ page = 1, limit = 10, task = "", mode = "", search = "", testId = "" } = {}) => {
    const params = new URLSearchParams({ page, limit });
...
export const groupChatAPI = {
  ...
  // Message Management
  sendMessage: (groupId, content, message_type = "text") =>
    request({
      url: `/group-chat/${groupId}/messages`,
      method: "POST",
  ...
  getMessages: (groupId, page = 1, limit = 50) =>
    request({
      url: `/group-chat/${groupId}/messages?page=${page}&limit=${limit}`,
      method: "GET",
    }),

  updateMessage: (messageId, content) =>
    request({
      url: `/group-chat/messages/${messageId}`,
      method: "PATCH",
      content: { content },
    }),
  ...
  addMember: (groupId, userId, role = "member") =>
    request({
      url: `/group-chat/${groupId}/members`,
      method: "POST",
      content: { userId, role },
    }),
  ...
  updateMemberRole: (groupId, memberId, role) =>
    request({
      url: `/group-chat/${groupId}/members/${memberId}/role`,
      method: "PATCH",
      content: { role },
    }),
  ...
  removeMember: (groupId, memberId) =>
    request({
      url: `/group-chat/${groupId}/members/${memberId}`,
      method: "DELETE",
    }),

  leaveGroup: (groupId) =>
    request({
      url: `/group-chat/${groupId}/members/me`,
      method: "DELETE",
    }),
};
...
export const groupChatWebSocket = {
  connect: (socketIoClient, token) => {
    if (!socketIoClient) {
      throw new Error("Socket.IO client is required. Install: npm install socket.io-client");
    }

    socketInstance = socketIoClient(`${BASE_URL.replace("/api", "")}/chat`, {
      auth: { token },
  ...
  joinGroup: (groupId) => {
    if (socketInstance) {
      socketInstance.emit("joinGroupChat", { groupId });
    }
  },

  leaveGroup: (groupId) => {
    if (socketInstance) {
      socketInstance.emit("leaveGroupChat", { groupId });
    }
  },

  sendMessage: (groupId, content, message_type = "text") => {
    if (socketInstance) {
      socketInstance.emit("sendGroupMessage", { groupId, content, message_type });
    }
  },

  sendTyping: (groupId, isTyping) => {
    if (socketInstance) {
      socketInstance.emit("groupTyping", { groupId, isTyping });
    }
  },

  getMembers: (groupId) => {
    if (socketInstance) {
      socketInstance.emit("getGroupMembers", { groupId });
    }
  },

  deleteMessage: (messageId, groupId) => {
    if (socketInstance) {
      socketInstance.emit("deleteGroupMessage", { messageId, groupId });
    }
  },
  ...
  onMessage: (callback) => {
    if (socketInstance) {
      socketInstance.on("groupMessage", callback);
    }
  },

  onTyping: (callback) => {
    if (socketInstance) {
      socketInstance.on("group-user-typing", callback);
    }
  },

  onMemberOnline: (callback) => {
    if (socketInstance) {
      socketInstance.on("member-online", callback);
    }
  },

  onMemberOffline: (callback) => {
    if (socketInstance) {
      socketInstance.on("member-offline", callback);
    }
  },

  onMembersList: (callback) => {
    if (socketInstance) {
      socketInstance.on("group-members", callback);
    }
  },
  ...
  offMessage: (callback) => {
    if (socketInstance) {
      socketInstance.off("groupMessage", callback);
    }
  },

  offTyping: (callback) => {
    if (socketInstance) {
      socketInstance.off("group-user-typing", callback);
    }
  },
};
