...
export const ieltsTestsAPI = {
  ...
  downloadJson: async (id) => {
    ...
    const res = await fetch(
      `https://backend.impulselc.uz/api/ielts-tests/${encodeURIComponent(id)}/download-json`,
      {
        method: "GET",
        headers: {
    ...
    a.download = match ? match[1] : `ielts-test-${id}.json`;
...
export const ieltsReadingAPI = {
  ...
  // Junction table — link/unlink/get linked reading parts (many-to-many)
  linkPart: (data) =>
    request({ url: "/ielts-reading/link-part", method: "POST", content: data }),

  unlinkPart: (data) =>
    request({
      url: "/ielts-reading/unlink-part",
      method: "DELETE",
      content: data,
    }),

  getLinkedParts: (readingId) =>
    request({
      url: `/ielts-reading/${readingId}/linked-parts`,
      method: "GET",
    }),
};
...
export const ieltsListeningAPI = {
  ...
  // Junction table — link/unlink/get linked listening parts (many-to-many)
  linkPart: (data) =>
    request({
      url: "/ielts-listening/link-part",
      method: "POST",
      content: data,
    }),
  ...
  unlinkPart: (data) =>
    request({
      url: "/ielts-listening/unlink-part",
      method: "DELETE",
      content: data,
    }),

  getLinkedParts: (listeningId) =>
    request({
      url: `/ielts-listening/${listeningId}/linked-parts`,
      method: "GET",
    }),
};
...
export const ieltsWritingAPI = {
  ...
  // Junction table — link/unlink/get linked writing tasks (many-to-many)
  linkTask: (data) =>
    request({
      url: "/ielts-writing/link-task",
      method: "POST",
      content: data,
    }),
  ...
  unlinkTask: (data) =>
    request({
      url: "/ielts-writing/unlink-task",
      method: "DELETE",
      content: data,
    }),

  getLinkedTasks: (writingId) =>
    request({
      url: `/ielts-writing/${writingId}/linked-tasks`,
      method: "GET",
    }),
};
...
export const ieltsQuestionsAPI = {
  ...
  // AI explainer — auto-generate `explanation` (Uzbek) + `fromPassage` (verbatim
  // quote) for a reading question and its sub-questions/options, based on the
  // reading passage. Persists the results and returns the refreshed question.
  aiExplain: (id) =>
    request({ url: `/ielts-questions/${id}/ai-explain`, method: "POST" }),
...
// Speaking API — /ielts-speaking
// AI examiner topics → parts (Part 1/2/3) → questions, plus attempt history.
export const ieltsSpeakingAPI = {
  // ── Topics ──
  getAll: (params = {}) => {
    const qs = new URLSearchParams();
    if (params.page) qs.set("page", String(params.page));
    ...
    const q = qs.toString();
    return request({ url: `/ielts-speaking${q ? `?${q}` : ""}`, method: "GET" });
  },

  getById: (id) => request({ url: `/ielts-speaking/${id}`, method: "GET" }),

  create: (data) =>
    request({ url: "/ielts-speaking", method: "POST", content: data }),

  update: (id, data) =>
    request({ url: `/ielts-speaking/${id}`, method: "PATCH", content: data }),

  delete: (id) => request({ url: `/ielts-speaking/${id}`, method: "DELETE" }),
  ...
  getParts: (params = {}) => {
    ...
    if (params.page) qs.set("page", String(params.page));
    if (params.limit) qs.set("limit", String(params.limit));
    if (params.speakingId) qs.set("speakingId", params.speakingId);
    if (params.part) qs.set("part", params.part);
    const q = qs.toString();
    return request({
      url: `/ielts-speaking/parts${q ? `?${q}` : ""}`,
      method: "GET",
    });
  },

  getPartById: (id) =>
    request({ url: `/ielts-speaking/part/${id}`, method: "GET" }),

  createPart: (data) =>
    request({ url: "/ielts-speaking/part", method: "POST", content: data }),

  updatePart: (id, data) =>
    request({ url: `/ielts-speaking/part/${id}`, method: "PATCH", content: data }),

  deletePart: (id) =>
    request({ url: `/ielts-speaking/part/${id}`, method: "DELETE" }),
  ...
  getQuestions: (params = {}) => {
    ...
    const q = qs.toString();
    return request({
      url: `/ielts-speaking/questions${q ? `?${q}` : ""}`,
      method: "GET",
    });
  },

  createQuestion: (data) =>
    request({ url: "/ielts-speaking/question", method: "POST", content: data }),

  bulkCreateQuestions: (data) =>
    request({
      url: "/ielts-speaking/questions/bulk",
      method: "POST",
      content: data,
    }),
  ...
  updateQuestion: (id, data) =>
    request({
      url: `/ielts-speaking/question/${id}`,
      method: "PATCH",
      content: data,
    }),

  deleteQuestion: (id) =>
    request({ url: `/ielts-speaking/question/${id}`, method: "DELETE" }),
  ...
  getMyAttempts: (params = {}) => {
    ...
    const q = qs.toString();
    return request({
      url: `/ielts-speaking/me/attempts${q ? `?${q}` : ""}`,
      method: "GET",
    });
  },

  getAttemptById: (id) =>
    request({ url: `/ielts-speaking/attempt/${id}`, method: "GET" }),
};
...
export const ieltsAnswersAPI = {
  ...
  getLeaderboard: (params = {}) => {
    ...
    const q = qs.toString();
    return request({
      url: `/ielts-answers/leaderboard${q ? `?${q}` : ""}`,
      method: "GET",
    });
  },
};
