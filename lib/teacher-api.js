...
// Guest Students API
export const guestStudentsAPI = {
  getAll: () => request({ url: "/users/guest-students", method: "GET" }),

  register: (data) =>
    request({ url: "/auth/guest/register", method: "POST", content: data }),

  hardDelete: (id) => request({ url: `/users/${id}/hard`, method: "DELETE" }),

  deactivate: (id) =>
    request({ url: `/users/${id}/deactivate`, method: "PATCH" }),

  activate: (id) => request({ url: `/users/${id}/activate`, method: "PATCH" }),
};
...
export const ieltsVocabularyAPI = {
  ...
  create: (data) =>
    request({ url: "/ielts-vocabulary", method: "POST", content: data }),

  update: (id, data) =>
    request({ url: `/ielts-vocabulary/${id}`, method: "PATCH", content: data }),

  delete: (id) => request({ url: `/ielts-vocabulary/${id}`, method: "DELETE" }),
};

// IELTS Vocabulary Decks API
export const ieltsVocabularyDecksAPI = {
  getAll: (vocabularyId, page = 1, limit = 10) => {
    const params = new URLSearchParams({
      page: String(page),
      limit: String(limit),
    });
    if (vocabularyId) params.append("vocabularyId", vocabularyId);
    return request({
      url: `/ielts-vocabulary/decks/all?${params.toString()}`,
      method: "GET",
    });
  },
  ...
  create: (data) =>
    request({ url: "/ielts-vocabulary/decks", method: "POST", content: data }),

  update: (id, data) =>
    request({
      url: `/ielts-vocabulary/decks/${id}`,
      method: "PATCH",
      content: data,
    }),

  delete: (id) =>
    request({ url: `/ielts-vocabulary/decks/${id}`, method: "DELETE" }),
};

// IELTS Vocabulary Words API
export const ieltsVocabularyWordsAPI = {
  getAll: (deckId, page = 1, limit = 20) => {
    const params = new URLSearchParams({
      page: String(page),
      limit: String(limit),
    });
    ...
    return request({
      url: `/ielts-vocabulary/words/all?${params.toString()}`,
      method: "GET",
    });
  },

  getById: (id) =>
    request({ url: `/ielts-vocabulary/words/${id}`, method: "GET" }),

  create: (data) =>
    request({ url: "/ielts-vocabulary/words", method: "POST", content: data }),

  update: (id, data) =>
    request({
      url: `/ielts-vocabulary/words/${id}`,
      method: "PATCH",
      content: data,
    }),

  delete: (id) =>
    request({ url: `/ielts-vocabulary/words/${id}`, method: "DELETE" }),
};
