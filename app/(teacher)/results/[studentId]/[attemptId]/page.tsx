...
export default function TeacherAttemptResultPage() {
  return (
    <ProtectedRoute>
...
function AttemptResultContent() {
  ...
  useEffect(() => {
    ...
    const fetchResult = async () => {
      ...
      setError(null);
      try {
        const data = await ieltsAnswersAPI.getMyStudentAttemptResult(
          studentId,
          attemptId,
        );
        ...
        // Fetch writing task details for prompts
            ...
            <Box textAlign="center" py={8} px={6}>
              <Flex justify="center" mb={4}>
                <Flex
                  ...
                  borderRadius="full"
                  borderWidth="3px"
                  borderColor={result.isCompleted ? "green.400" : "orange.400"}
                  color={result.isCompleted ? "green.400" : "orange.400"}
                >
